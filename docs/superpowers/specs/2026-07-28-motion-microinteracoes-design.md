...
3. Os 4 números da `TrustStatsBar` contam de 0 até o valor final na primeira vez que entram na viewport, e não recontam em navegações de volta à home dentro da mesma sessão de página (dispara uma vez).
